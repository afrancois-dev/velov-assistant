...
<video src="https://github.com/user-attachments/assets/32fd6466-52bf-41d3-ade5-64e538547685" controls width="25%"></video>
- **Function calling** — one `get_velov_info` facade for real-time station availability and nearby lookups.
<video src="https://github.com/user-attachments/assets/9d50a4c8-f47d-48b8-86cb-fc16d4bf9ab1" controls width="25%"></video>
